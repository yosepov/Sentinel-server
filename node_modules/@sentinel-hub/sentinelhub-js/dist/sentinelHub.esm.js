...
import { union, intersection } from 'polygon-clipping';
...
function fetchGetCapabilitiesXml(baseUrl, ogcServiceType, reqConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parsedXml = yield parseStringPromise(res.data);
        return parsedXml;
    });
}
...
class AbstractLayer {
                ...
                for (let i = 0; i < maxFindTilesRequests; i++) {
                    ...
                    for (let tileIndex = 0; tileIndex < tiles.length; tileIndex++) {
                        ...
                        if (diffS > orbitTimeS) {
                            ...
                            currentFlyoverGeometry = union(this.roundCoordinates(currentFlyoverGeometry), this.roundCoordinates(tiles[tileIndex].geometry.coordinates));
    ...
    calculateCoveragePercent(bboxGeometry, bboxArea, flyoverGeometry) {
        ...
        try {
            bboxedFlyoverGeometry = intersection(this.roundCoordinates(bboxGeometry), this.roundCoordinates(flyoverGeometry));
        }
        catch (ex) {
...
class AbstractSentinelHubV1OrV2Layer extends AbstractLayer {
    ...
    getStats(params, reqConfig = {}, statsProvider = StatisticsProviderType.FIS) {
        return __awaiter(this, void 0, void 0, function* () {
...
class AbstractSentinelHubV3Layer extends AbstractLayer {
    ...
    createCatalogPayloadQuery(maxCloudCoverPercent, // eslint-disable-line @typescript-eslint/no-unused-vars
    datasetParameters) {
        return null;
    }
    findTilesUsingCatalog(authToken, bbox, fromTime, toTime, maxCount = null, offset = null, reqConfig, findTilesAdditionalParameters, intersects) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shServiceHostname = this.getShServiceHostname();
            return yield axios.post(`${shServiceHostname}api/v1/catalog/search`, payload, requestConfig);
        });
    }
    getFindDatesUTCAdditionalParameters(reqConfig) {
        return __awaiter(this, void 0, void 0, function* () {
...
class S1GRDAWSEULayer extends AbstractSentinelHubV3Layer {
    ...
    createCatalogPayloadQuery(maxCloudCoverPercent, datasetParameters) {
        let result = Object.assign({}, super.createCatalogPayloadQuery(maxCloudCoverPercent, datasetParameters));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (authToken && preferGetCapabilities === false) {
                try {
                    ...
                    layersInfos = layers.map((l) => (Object.assign(Object.assign({}, l), { dataset: l.type && LayersFactory.DATASET_FROM_JSON_GETCAPAPABILITIES[l.type]
            ...
            if (!layersInfoFetched) {
                ...
                layersInfos = getCapabilitiesJson.map(layerInfo => ({
                    ...
                    dataset: layerInfo.dataset && LayersFactory.DATASET_FROM_JSON_GETCAPAPABILITIES[layerInfo.dataset]
...
function legacyGetMapFromUrl(urlWithQueryParams, api = ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams) {
    return __awaiter(this, void 0, void 0, function* () {
...
function legacyGetMapFromParams(baseUrl, wmsParams, api = ApiType.WMS, fallbackToWmsApi = false, overrideLayerConstructorParams, overrideGetMapParams, requestConfig, preferGetCapabilities = true) {
    return __awaiter(this, void 0, void 0, function* () {
...
export { LayersFactory, DATASET_BYOC, DATASET_AWSEU_S1GRD, DATASET_EOCLOUD_S1GRD, DATASET_S2L2A, DATASET_S2L1C, DATASET_S3SLSTR, DATASET_S3OLCI, DATASET_S5PL2, DATASET_AWS_L8L1C, DATASET_AWS_LOTL1, DATASET_AWS_LOTL2, DATASET_AWS_LTML1, DATASET_AWS_LTML2, DATASET_AWS_LMSSL1, DATASET_AWS_LETML1, DATASET_AWS_LETML2, DATASET_EOCLOUD_LANDSAT5, DATASET_EOCLOUD_LANDSAT7, DATASET_EOCLOUD_LANDSAT8, DATASET_EOCLOUD_ENVISAT_MERIS, DATASET_MODIS, DATASET_AWS_DEM, DATASET_AWSUS_DEM, WmsLayer, WmtsLayer, PlanetNicfiLayer, S1GRDAWSEULayer, S1GRDEOCloudLayer, S2L2ALayer, S2L1CLayer, S3SLSTRLayer, S3OLCILayer, S5PL2Layer, EnvisatMerisEOCloudLayer, MODISLayer, DEMAWSUSLayer, DEMLayer, Landsat5EOCloudLayer, Landsat7EOCloudLayer, Landsat8EOCloudLayer, Landsat8AWSLayer, Landsat8AWSLOTL1Layer, Landsat8AWSLOTL2Layer, Landsat45AWSLTML1Layer, Landsat45AWSLTML2Layer, Landsat15AWSLMSSL1Layer, Landsat7AWSLETML1Layer, Landsat7AWSLETML2Layer, BYOCLayer, ProcessingDataFusionLayer, setAuthToken, isAuthTokenSet, requestAuthToken, LinkType, ApiType, SUPPORTED_CRS_OBJ, CRS_EPSG4326, CRS_EPSG3857, CRS_WGS84, MimeTypes, AcquisitionMode, Polarization, Resolution, SpeckleFilterType, OrbitDirection, PreviewMode, MosaickingOrder, Interpolator, BackscatterCoeff, DEMInstanceType, DEMInstanceTypeOrthorectification, S3SLSTRView, BBox, LocationIdSHv3, setDebugEnabled, CancelToken, isCancelled, CacheTarget, invalidateCaches, registerHostnameReplacing, setDefaultRequestsConfig, drawBlobOnCanvas, canvasToBlob, SHV3_LOCATIONS_ROOT_URL, BYOCSubTypes, legacyGetMapFromUrl, legacyGetMapWmsUrlFromParams, legacyGetMapFromParams, parseLegacyWmsGetMapParams, wmsGetMapUrl as _wmsGetMapUrl, StatisticsProviderType, StatisticsUtils, TPDI, TPDICollections, TPDProvider, AirbusConstellation, AirbusProcessingLevel, TPDITransactionStatus, PlanetItemType, PlanetProductBundle, PlanetSupportedProductBundles, PlanetScopeHarmonization, MaxarSensor, ResamplingKernel };
